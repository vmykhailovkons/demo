...
function Button() {
  return (
    <div className="absolute bg-[#155dfc] box-border content-stretch flex gap-[8px] h-[44px] items-center justify-center left-[23px] pl-0 pr-[0.016px] py-0 rounded-[8px] shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.1),0px_2px_4px_-2px_rgba(0,0,0,0.1)] top-[385px] w-[950px]" data-name="Button">
      <Paragraph5 />
    </div>
  );
}
...
function Button1() {
  return (
    <div className="absolute bg-[#155dfc] box-border content-stretch flex gap-[8px] h-[44px] items-center justify-center left-[36px] pl-0 pr-[0.016px] py-0 rounded-[8px] top-[523px] w-[955px]" data-name="Button">
      <Paragraph9 />
    </div>
  );
}
