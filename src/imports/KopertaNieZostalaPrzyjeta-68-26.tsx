...
function Paragraph1() {
  return (
    <div className="absolute h-[24px] left-[93.63px] top-[12.5px] w-[136.938px]" data-name="Paragraph1">
      <p className="absolute font-['Arial:Regular',sans-serif] leading-[24px] left-[68px] not-italic text-[#314158] text-[16px] text-center text-nowrap top-0 translate-x-[-50%] whitespace-pre">Błędny kod QR</p>
    </div>
  );
}
