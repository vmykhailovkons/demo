import svgPaths from "./svg-tdcsqi9yqr";
...
function Container() {
  return (
    <div className="h-[36px] relative shrink-0 w-[245px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[36px] w-[245px]" />
    </div>
  );
}
...
function Heading1() {
  return (
    <div className="absolute h-[36px] left-[44px] top-0 w-[200.109px]" data-name="Heading 1">
      <p className="absolute font-['Arial:Regular',sans-serif] leading-[36px] left-0 not-italic text-[24px] text-nowrap text-white top-0 whitespace-pre">Dodaj użytkownika</p>
    </div>
  );
}
...
function Container1() {
  return (
    <div className="absolute h-[36px] left-[76px] top-[14px] w-[252px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[36px] relative w-[252px]">
        <Heading1 />
      </div>
    </div>
  );
...
function Container3() {
  return <div className="absolute h-[172.643px] left-[127px] top-[168px] w-[320px]" data-name="Container" />;
}

function Icon2() {
  return (
    <div className="relative shrink-0 size-[93px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 93 93">
        <g id="Icon">
          <path d={svgPaths.p3313cc0} id="Vector" stroke="var(--stroke-0, #2B7FFF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="7.75" />
          <path d="M7.75057 38.7508H85.2506" id="Vector_2" stroke="var(--stroke-0, #2B7FFF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="7.75" />
        </g>
      </svg>
    </div>
  );
...
function Container4() {
  return (
    <div className="absolute content-stretch flex h-[60px] items-center justify-center left-[123px] opacity-[0.957] rounded-[7.8014e+07px] top-[18px] w-[87px]" data-name="Container">
      <Icon2 />
    </div>
  );
}
...
function Heading3() {
  return (
    <div className="absolute content-stretch flex h-[73px] items-start left-[-16px] top-[90px] w-[196px]" data-name="Heading 3">
      <p className="font-['Arial:Bold',sans-serif] leading-[72.521px] not-italic relative shrink-0 text-[#3384ff] text-[51.801px] text-center w-[365px]">Zbliż kartę</p>
    </div>
  );
}
...
function App() {
  return (
    <div className="bg-gradient-to-r from-[#eef2ff] h-[200px] relative rounded-[14px] shrink-0 to-[#eff6ff] w-full" data-name="App">
      <div aria-hidden="true" className="absolute border-2 border-[#2b7fff] border-solid inset-0 pointer-events-none rounded-[14px]" />
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col h-[200px] items-start pb-[2px] pt-[26px] px-[26px] relative w-full">
          <Container5 />
        </div>
      </div>
    </div>
  ...
  return (
    <div className="h-[20px] relative shrink-0 w-[86.719px]" data-name="Primitive.span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[8px] h-[20px] items-center overflow-clip relative rounded-[inherit] w-[86.719px]">
        <p className="font-['Arial:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#717182] text-[14px] text-nowrap whitespace-pre">Wybierz rolę...</p>
      </div>
    </div>
  );
}
...
function App1() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[354px] items-start left-[314px] top-[36px] w-[390px]" data-name="App">
      <App />
      <Container6 />
    </div>
  );
...
export default function DodajUzytkownika() {
  return (
    <div className="relative size-full" data-name="Dodaj użytkownika">
      <Container2 />
      <Container7 />
    </div>
  );
