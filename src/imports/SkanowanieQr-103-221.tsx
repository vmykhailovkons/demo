...
function LoginScreen() {
  return <div className="absolute bg-white h-[37px] left-[-25px] rounded-[10px] top-[184px] w-[916px]" data-name="LoginScreen1" />;
}
...
function Container() {
  return (
    <div className="absolute bg-blue-50 box-border content-stretch flex h-[128px] items-center justify-center left-[39px] p-[4px] rounded-[14px] top-[24px] w-[920px]" data-name="Container">
...
function VirtualKeyboard950X() {
  return (
    <div className="absolute h-[200px] left-[22px] top-[280px] w-[950px]" data-name="VirtualKeyboard950X200">
      <Container6 />
      <Container7 />
      <Container10 />
      <Container17 />
...
function Container5() {
  return (
    <div className="absolute content-stretch flex flex-col h-[37px] items-start left-[39px] rounded-[10px] top-[208px] w-[916px]" data-name="Container5">
      <Container87 />
    </div>
  );
}
...
function Button() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.1)] box-border content-stretch flex gap-[8px] h-[37px] items-center left-[16px] px-[16px] py-0 rounded-[8px] top-[12px] w-[92.422px]" data-name="Button">
      <Icon />
      <Text />
    </div>
  );
