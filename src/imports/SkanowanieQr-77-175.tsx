...
function Container() {
  return (
    <div className="absolute bg-green-50 box-border content-stretch flex h-[225px] items-center justify-center left-[37px] p-[4px] rounded-[14px] top-[20px] w-[920px]" data-name="Container">
