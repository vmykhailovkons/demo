import svgPaths from "./svg-yh1sykmpqd";
...
function Container5() {
  return (
    <div className="absolute content-stretch flex flex-col h-[37px] items-start left-0 rounded-[10px] top-0 w-[916px]" data-name="Container5">
      <Container />
    </div>
  );
}
...
function VirtualKeyboard950X200() {
  return (
