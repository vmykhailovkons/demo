import svgPaths from "./svg-6c21x43siq";
...
function Heading2() {
  return (
    <div className="absolute h-[36px] left-[123px] top-[15px] w-[200.109px]" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[36px] relative w-[200.109px]">
...
function Container2() {
  return <div className="absolute h-[60px] left-[588px] top-[162px] w-[214px]" data-name="Container" />;
}

function Heading3() {
  return (
    <div className="absolute content-stretch flex h-[73px] items-start left-[-16px] top-[90.43px] w-[196px]" data-name="Heading 3">
      <p className="font-['Arial:Bold',sans-serif] leading-[72.521px] not-italic relative shrink-0 text-[51.801px] text-center text-green-500 w-[365px]">Zeskanowano</p>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="h-[156px] relative shrink-0 w-full" data-name="Container">
      <Heading3 />
      <div className="absolute inset-[17.31%_35.96%_50.32%_42.31%]" data-name="Vector">
        <div className="absolute inset-[-13.64%_-9.38%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 88 65">
            <path d={svgPaths.p3d136d60} id="Vector" stroke="var(--stroke-0, #22C55E)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="13.7727" />
          </svg>
        </div>
      </div>
    </div>
...
function App() {
  return (
    <div className="bg-green-50 h-[200px] relative rounded-[14px] shrink-0 w-full" data-name="App">
      <div aria-hidden="true" className="absolute border-2 border-green-500 border-solid inset-0 pointer-events-none rounded-[14px]" />
  ...
  return (
    <div className="h-[20px] relative shrink-0 w-[86.719px]" data-name="Primitive.span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[8px] h-[20px] items-center overflow-clip relative rounded-[inherit] w-[86.719px]">
        <p className="font-['Arial:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#717182] text-[14px] text-nowrap whitespace-pre">11111</p>
      </div>
    </div>
  );
}
...
function Container4() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[390px]" data-name="Container">
      <PrimitiveLabel />
      <PrimitiveButton />
    </div>
  );
...
function PrimitiveButton1() {
  return (
    <div className="h-[36px] opacity-50 relative rounded-[8px] shrink-0 w-full" data-name="Primitive.button">
