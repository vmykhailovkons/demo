import svgPaths from "./svg-x7b5gi836x";
...
function Button3() {
  return (
    <div className="absolute bg-[#2b7fff] h-[36px] left-[50px] rounded-[8px] top-[446px] w-[894px]" data-name="Button">
      <p className="absolute font-['Arial:Regular',sans-serif] leading-[21px] left-[444.5px] not-italic text-[14px] text-center text-white top-[6px] translate-x-[-50%] w-[117px]">Dodaj użytkownika</p>
    </div>
  );
}
