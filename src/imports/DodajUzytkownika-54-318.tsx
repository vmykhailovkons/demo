import svgPaths from "./svg-ym4mt9tnh5";
...
function Container() {
  return (
    <div className="absolute h-[36px] left-[77px] top-[14px] w-[252px]" data-name="Container">
...
function Heading3() {
  return (
    <div className="absolute content-stretch flex h-[73px] items-start left-[-16px] top-[90.43px] w-[196px]" data-name="Heading 3">
      <p className="font-['Arial:Bold',sans-serif] leading-[72.521px] not-italic relative shrink-0 text-[#3384ff] text-[51.801px] text-center w-[365px]">Skanowanie</p>
    </div>
  );
}
...
function Icon2() {
  return (
    <div className="absolute left-[135px] size-[81px] top-[9px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 81 81">
        <g id="Icon">
          <path d={svgPaths.p2b102b70} id="Vector" stroke="var(--stroke-0, #3384FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="6.75" />
        </g>
      </svg>
    </div>
  );
