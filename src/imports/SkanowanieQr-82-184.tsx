  ...
  return (
    <div className="h-[208px] relative shrink-0 w-[865px]" data-name="Frame">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[208px] relative w-[865px]">
        <Paragraph1 />
        <div className="absolute font-['Arial:Regular',sans-serif] h-[110px] leading-[24px] left-[431.5px] not-italic text-[#fb2c36] text-[96px] text-center top-[25px] translate-x-[-50%] w-[916px]">
...
function Button() {
  return (
    <div className="absolute bg-[#155dfc] box-border content-stretch flex gap-[8px] h-[44px] items-center justify-center left-[610px] pl-0 pr-[0.016px] py-0 rounded-[8px] shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.1),0px_2px_4px_-2px_rgba(0,0,0,0.1)] top-[434px] w-[347px]" data-name="Button">
      <Paragraph />
    </div>
  );
}
...
function Button1() {
  return (
    <div className="absolute bg-[#155dfc] box-border content-stretch flex gap-[8px] h-[44px] items-center justify-center left-[37px] pl-0 pr-[0.016px] py-0 rounded-[8px] top-[434px] w-[347px]" data-name="Button">
      <Paragraph2 />
    </div>
  );
}
