interface OpenSlotScreenProps {
  onClick: () => void;
}

export function OpenSlotScreen({ onClick }: OpenSlotScreenProps) {
  return (
            ...
            >
              ...
              <div className="size-full">
                <div className="box-border content-stretch flex flex-col h-[355px] items-start pb-[4px] pt-[36px] px-[36px] relative w-full">
                  <p className="absolute font-['Arial:Regular',sans-serif] h-[57px] leading-[27px] left-[447px] not-italic text-[#2b7fff] text-[96px] text-center top-[149px] translate-x-[-50%] w-[760px]">Otwórz wrzutnię</p>
                </div>
              </div>
            </div>
