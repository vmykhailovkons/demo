interface VirtualKeyboard950Props {
  onKeyPress: (key: string) => void;
  onBackspace: () => void;
}

export function VirtualKeyboard950({ onKeyPress, onBackspace }: VirtualKeyboard950Props) {
  ...
  return (
    <div className="relative h-[200px] w-[950px]">
      {/* Number Row */}
